...
public class EasyTaskStatus {
	...
	public static final int TASK_STATUS_DOWNLOAD_START = TASK_STATUS_CONNECTING + 1;
	public static final int TASK_STATUS_DOWNLOADING = TASK_STATUS_DOWNLOAD_START + 1;
